...
internal fun Route.signIn() {
     ...
     * Response: 422 application/x-protobuf [com.bookk.core.domain.entity.SimpleServerError] Sign in errors<br>CHALLENGE_WINDOW_EXPIRED (Code 300001) Challenge window expired<br>VERIFICATION_FAILED (Code 300002) Passkey verification failed<br>PASSKEY_OWNER_NOT_FOUND (Code 300003) Passkey owner not found
     */
