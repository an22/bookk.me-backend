package com.bookk.auth.data.encryption
...
internal object SigningKeyCipher {
    ...
    fun encrypt(plaintext: String, key: String = AppLevelConstants.signingKeyEncryptionKey): String {
    ...
    fun decrypt(encoded: String, key: String = AppLevelConstants.signingKeyEncryptionKey): String {
