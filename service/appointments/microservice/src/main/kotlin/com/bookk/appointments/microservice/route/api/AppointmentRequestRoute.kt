...
fun Routing.requests() {
    authenticate {
         ...
         * Response: 404 application/x-protobuf [com.bookk.core.domain.entity.SimpleServerError] Create appointment request errors<br>BUSINESS_EMPLOYEE_NOT_EXISTS (200024) Employee with this id is missing<br>BUSINESS_CLIENT_NOT_EXISTS (200006) Client with this id is missing
