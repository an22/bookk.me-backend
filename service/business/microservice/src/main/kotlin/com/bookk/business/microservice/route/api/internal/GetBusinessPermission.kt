...
internal fun Route.getBusinessPermission() {
     ...
     * Description: Permission the user holds on the business, zero when the user holds none. Used by other services to authorize business scoped actions
     * Tag: internal
     * Response: 200 application/x-protobuf [kotlin.Int] Permission value
     */
