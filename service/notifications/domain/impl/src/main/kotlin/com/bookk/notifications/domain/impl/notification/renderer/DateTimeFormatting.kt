...
private val FORMATTERS: Map<Language, DateTimeFormatter> = mapOf(
    Language.EN to DateTimeFormatter.ofPattern("MMM d, yyyy h:mm a", Locale.ENGLISH),
    Language.UK to DateTimeFormatter.ofPattern("d MMMM yyyy 'р.', HH:mm", Locale.forLanguageTag("uk")),
)
