...
fun Routing.appointmentInit() {
    authenticate {
         ...
         * Response: 422 application/x-protobuf [com.bookk.core.domain.entity.SimpleServerError] Appointment errors<br>PLUGIN_ALREADY_ENABLED (Code 300009) Appointment plugin already enabled
         */
