#!/bin/sh
openssl req -x509 -newkey rsa:4096 -keyout ca.key -out ca.crt -sha256 -days 365 -nodes -subj "/C=JP/ST=Hokkaido/L=Hokkaido/O=BlankCompany/OU=BlankSectionName/CN=local.bookkme.app"
