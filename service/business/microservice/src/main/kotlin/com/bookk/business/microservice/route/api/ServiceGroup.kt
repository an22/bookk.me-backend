...
fun Route.serviceGroupCrud() {
    authenticate {
         ...
         * Response: 422 application/x-protobuf [com.bookk.core.domain.entity.SimpleServerError] Create service group errors<br>BUSINESS_SERVICE_GROUP_EXISTS (Code 200010) Service group with this name already exists<br>BUSINESS_SERVICE_GROUP_VALIDATION_ERROR (Code 200011) Invalid service group name
         */
