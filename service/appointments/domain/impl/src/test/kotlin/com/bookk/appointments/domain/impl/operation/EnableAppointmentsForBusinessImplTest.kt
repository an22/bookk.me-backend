...
internal class EnableAppointmentsForBusinessImplTest {
    ...
    @Test
    fun `should return failure when permissions initialization fails`() = runUnitTest {
        val fixture = SutFixture()
        given()
        fixture.transactionManager.mockTransaction()

        coEvery { fixture.subscriptionSource.attachBusiness(testSnapshot) } returns Unit
        coEvery { fixture.permissionsDataSource.initPermissions(testUserId, testBusinessId, ObjectPermission.OWNER.int) } throws RuntimeException("Auth fail")
